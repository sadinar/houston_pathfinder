...
class TestAttack(unittest.TestCase):
    ...
    def test_attack_generates_base_attack_bonus(self):
        ...
        attack = Attack('some other name', [strength], [dexterity], [fighter, rogue])
    ...
    def test_attack_generates_full_attack(self):
        ...
        attack = Attack('yet another name', [strength], [dexterity], [fighter, rogue])
    ...
    def test_attack_calculates_damage(self):
        dexterity = Attribute(Attribute.DEXTERITY, 3)
        strength = Attribute(Attribute.STRENGTH, 19)
        fighter = Fighter(2)
        rogue = Rogue(13)

        attack = Attack('Bob Bobberton', [strength, dexterity], [dexterity], [fighter, rogue])
        self.assertEqual('1d3+0', attack.get_damage())
